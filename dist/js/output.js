...
define("jquery-megamenu", ["jquery"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.jQuery.fn.accessibleMegaMenu;
    };
}(this)));

define('app/NCI/version',['require','jquery'],function(require) {
	var $ = require('jquery');

	var version = function() {
		$('body').append("<div>ASD</div>");
	};

	return version;
});

define('app/NCI',['require','./NCI/version','./NCI/version'],function(require) {
	var NCI = {
...
define('app/Home',['require','jquery-megamenu','./NCI'],function (require) {
